...
def Task_Execution():
    ...
    wish_me()
    if 1:
        speak("hello, I am Gyan bot")
        speak("I will help you on your journey to ancient time")
        speak("would you like to see a video about ancient languages, if yes please say 'play the video'")
    while True:
